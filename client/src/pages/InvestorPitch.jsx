...
const InvestorPitch = () => {
  ...
  const handleMessageOwner = async() => {
    ...
    const pitchTitle = pitch.title.replace(/\s+/g, '');
    // const pitchTitle = encodeURIComponent(pitch.title); // Ensure safe URL encoding
    const pitchImage = pitch.pitchImages[0];
    console.log("Pitch Images", pitch.pitchImages);
    console.log("Pitch Images 1", pitch.pitchImages[0]);
    ...
    <div className="w-full bg-[#0A0A0A] flex flex-col text-white p-2">
      ...
      <div className="p-9 mb-4">
        ...
        <div className="flex gap-5 items-center mt-5 w-full">
          ...
          <div className="bg-[#1E1E1E] p-8 rounded-lg w-[50%]">
            <div className="flex justify-around font-medium items-center">
              <Button name="Message Owner" className="w-[15rem]" handler={handleMessageOwner} />
              <InvestForm

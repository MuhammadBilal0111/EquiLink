...
const AddPitch = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const contractData = {
      ...
      category: formDataObject.categoryName,
      ...
      <div className="w-4/5 mt-2">
        <div className="flex flex-col items-center gap-2 justify-center border-b border-b-[#3F3F3F] my-12">
          ...
          <p className="text-[#C5C5C5] text-sm mb-4">
            Add an impressive pitch with video and images related to your idea
              ...
              <div className="flex gap-4 items-center">
                ...
                {videoFile && (
                  <div className="relative w-[140px] h-[90px]">
                    ...
                    <IoMdCloseCircle
                      className="absolute top-0 right-0 m-2 text-xl text-white cursor-pointer"
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <input
                  ...
                  className="hidden"
                  accept="image/*"
                  onChange={(e) => handleFileChange(e, setImageFiles, true)}
                />
                {/* Display Images */}
